...
### [ ] B1 — requestId par instance, pas par appel
...
### [ ] B3 — location parsing off en production par defaut
...
### [ ] A1 — unifier l'interface Transport
...
### [ ] B4 — error handling dans la boucle transport
...
### [ ] A2 — supprimer TransportConfig.enabled
...
### [ ] A5 — nettoyer __testing__ exports
...
### [ ] B7 — fixer le type de location quand disabled
