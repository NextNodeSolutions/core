...
describe("generateRequestId", () => {
	...
	it("should work in browser environment with Web Crypto API", () => {
		...
		vi.stubGlobal("crypto", {
			randomUUID: vi.fn().mockReturnValue("12345678-abcd-efgh-ijkl-mnopqrstuvwx"),
		});
	...
	it("should work in Node.js environment with crypto global", () => {
		...
		const mockCrypto = {
			randomUUID: vi.fn().mockReturnValue("abcdefgh-1234-5678-9012-abcdefghijkl"),
		};
...
describe("safeStringify", () => {
	...
	it("should handle functions", () => {
		...
		expect(safeStringify(anonymousFunction)).toBe("[Function: anonymousFunction]");
	});
